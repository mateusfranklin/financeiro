  <!-- Modal -->
  <div class="modal fade" id="modalNewIncome" tabindex="-1" aria-labelledby="modalTitle" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        {{-- Header --}}
        <div class="modal-header">
          <h5 class="modal-title" id="modalTitle">Nova Receita</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>

        <form action="/dashboard/new-income" method="post">
          @csrf
          {{-- Update --}}
          ...
          <div class="modal-body">
            ...
            <div class="row">
              ...
              <div class="col input-group">
                ...
                <div class="input-group">
                  <input type="text" class="form-control" id="company" name="company" description="name"
                    placeholder="Nome">
                </div>
              </div>
            </div>
            ...
            <div class="row">
              ...
              {{-- Due Date --}}
              <div class="col-4 form-group">
                <label for="due_date" class="form-label">Pagamento</label>
                <div class="input-group">
